...
//
    ...
    String path="E:\\Java\\BtNganHangKhachHangCheckout\\trunk\\OutputHSBC.txt";
    Write write = new Write();

    public void GhiDuLieuKhachHSBC() {
       write.GhiDuLieuKhach(path, listKhachHangHSBC);
    }

    public void DocDuLieuHSBC(){
